...
module.exports = async (dataCompany) => {
    ...
    let { id, email, enabled, role, cuit, company_name: companyName, url_image: urlImage, address, phone, description } = updatedCompany;
    return { id, email, enabled, role, cuit, companyName, urlImage, address, phone, description };
};