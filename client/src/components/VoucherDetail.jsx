...
export default function VoucherDetail({ id, activeUser, user }) {
    ...
    const [review, setReview] = useState({
        userId: Number(user),
        itemId: Number(id),
        comment: reviewForVoucherBought?.enabled && reviewForVoucherBought?.comment || "",
        star1: reviewForVoucherBought?.enabled && reviewForVoucherBought?.star1 || false,
        star2: reviewForVoucherBought?.enabled && reviewForVoucherBought?.star2 || false,
        star3: reviewForVoucherBought?.enabled && reviewForVoucherBought?.star3 || false,
        star4: reviewForVoucherBought?.enabled && reviewForVoucherBought?.star4 || false,
        star5: reviewForVoucherBought?.enabled && reviewForVoucherBought?.star5 || false,
    });
          ...
          <h1>Leave a review of your purchase</h1>
              ...
              {/* TEXT AREA*/}
                            <textarea
                                type="text"
                                name="comment"
                                placeholder={reviewForVoucherBought?.enabled ? reviewForVoucherBought.comment : "Leave a comment..."}
