    ...
    <>
        ...
        <div className=" flex w-3/4 m-auto items-center">
          <div className="flex items-center h-full ml-10 mr-auto">
            ...
            {activeUser.role === "ADMIN" && (
              <Link
                className="hover:text-blue-500 ml-10"
                href={`/admin?user=${activeUser.role}`}
              >
                Dashboard
              </Link>
            )}
            {activeUser.role === "COMPANY" && (
              <Link
                href={`/profile?user=${activeUser.role}`}
            ...
            {!activeUser.id ? (
              ...
              <>
                ...
                <Link
                  href={
                    activeUser.role !== "ADMIN"
                      ? `/profile?user=${activeUser.role}`
                      : `/admin?user=${activeUser.role}`
                  }
      ...
      <div className="flex items-center w-full h-12 bg-neutral-800 mt-16">
        <div className=" flex w-3/4 m-auto">
          ...
          {role !== "MEMBER" && role !== "COMPANY" && role !== "ADMIN" && (
            <div className="flex h-full mr-auto text-white">
              <Link
                href={"/brands"}
